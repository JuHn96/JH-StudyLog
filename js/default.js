...
(() => {
  const t = {
    ...
    setSettings: { tm: "setUserSettingsFunc", one: "setUserSettingsONEFunc" },
    countriesEurope: {
      AT: "Austria",
      BE: "Belgium",
      BG: "Bulgaria",
  ...
  var f =
      (null === (c = document.getElementById("cookiePolicyModal")) ||
      void 0 === c
        ? void 0
        : c.getAttribute("data-project")) || "tm",
  ...
  var v = function () {
      ...
      y("consent", t, {
        ...
        d("ad_storage", o || c ? "granted" : "denied", 14, h),
        d("ad_user_data", o || c ? "granted" : "denied", 14, h),
        d("ad_personalization", o || c ? "granted" : "denied", 14, h),
        d("analytics_storage", o || a ? "granted" : "denied", 14, h),
        d("functionality_storage", o || i || a ? "granted" : "denied", 14, h),
        d("personalization_storage", o || i || a ? "granted" : "denied", 14, h),
        d("security_storage", "granted", 14, h),
        "update" === t && window.dataLayer.push({ event: "consent_updated" });
    },
    g = (function () {
      var t = l(
        u().mark(function t() {
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    break;
                  case 6:
                    return (t.prev = 6), (t.next = 9), g();
                  case 9:
                    (n = t.sent),
                      (r = null == n ? void 0 : n.country_code),
                      d("country_code", r, 14, h),
                      (t.next = 16);
                    break;
                  case 14:
                    (t.prev = 14), (t.t0 = t.catch(6));
                  case 16:
                    (o = Object.keys(i.countriesEurope)),
                      (a =
                        null == o
                          ? void 0
                          : o.find(function (t) {
                      ...
                      d("ad_storage", c, 14, h),
                      d("ad_user_data", c, 14, h),
                      d("ad_personalization", c, 14, h),
                      d("analytics_storage", c, 14, h),
                      d("functionality_storage", c, 14, h),
                      d("personalization_storage", c, 14, h),
                      d("security_storage", "granted", 14, h);
                  case 27:
                  case "end":
                    return t.stop();
      ...
      for (;;)
        switch ((t.prev = t.next)) {
          case 0:
            ...
            return (
              (window.dataLayer = window.dataLayer || []), (t.next = 4), m()
            );
          case 4:
            t.next = 7;
            break;
